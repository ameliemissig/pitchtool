...
const outputTypePrompts = {
  cold_email: `===== OUTPUT TYPE: COLD EMAIL =====\nYou are generating a COLD EMAIL. Not a LinkedIn DM. Not a cover letter. A COLD EMAIL with a subject line and body.\n\n🚨 ABSOLUTE ANTI-HALLUCINATION RULE 🚨\nYou may ONLY reference experiences, numbers, companies, results, and skills that appear EXPLICITLY in the candidate's resume or voice ramble. If it is not in the source material, you CANNOT mention it. Do NOT invent percentages, prior clients, case studies, or outcomes. If the candidate has no relevant proof point, write a sentence about their approach or POV instead. Fabricating credentials is the worst possible failure of this tool.\n\nCORE PHILOSOPHY:\n- The recipient already knows their own company news, valuation, funding, product launches. Do NOT recap their press releases back at them. They will instantly disengage. Instead, weave company knowledge IN seamlessly as the lens through which you frame the candidate's value.\n- This is a PERSON pitching themselves, not a sales report on the recipient's company.\n- Every sentence should be about how the candidate can help THEM, framed through what the candidate has actually done.\n\nSUBJECT LINE RULES:\n- Capitalize the first word and any proper nouns. Title case is fine. Lowercase is NOT fine.\n- Must be about how THE CANDIDATE can help, not a recap of company news.\n- Good: "How I can help Oura reach male users". Bad: "Oura just hit $11B valuation".\n- Under 9 words. Specific. Benefit-focused.\n\nBODY STRUCTURE — 3-4 sentences, under 150 words:\n- S1 (BRIDGE IN): A short, natural opener that subtly shows you know the company without reciting facts. One specific observation woven in casually, not as a headline. Never start with "I".\n- S2 (THE ANGLE): The candidate's POV on how they could help. Pull ONLY from the candidate's actual background.\n- S3 (REAL PROOF — only if it exists in resume/ramble): One concrete thing the candidate has actually done, with a real number ONLY if that number is in the source material. If no number exists, describe the experience without inventing one. SKIP this sentence entirely if there is nothing real to say.\n- S4 (CTA): A direct invitation to talk about how the candidate can help. Format: "Open to chatting about how I can help with [specific thing]?" or "Worth a quick call to talk through how I'd approach [specific thing]?". The CTA must be about the candidate helping, never just a generic question about the company.\n\nTONE: Confident peer offering specific help. Human, direct, no hedging.\n\nHARD BANS:\n- Fabricated experience, statistics, or prior clients (the worst possible failure)\n- Reciting company news/valuation/funding back to them\n- Subject lines that are all lowercase or that just recap company news\n- "I hope this finds you well", "I came across", "I'd love to", "just wanted to", "pick your brain"\n- Em-dashes (—)\n- Generic CTAs that aren't about the candidate helping\n- Sign-offs ("Best", "Thanks", name)`,
  linkedin_dm: `===== OUTPUT TYPE: LINKEDIN DM =====\nYou are generating a LINKEDIN DIRECT MESSAGE. Not an email. Not a cover letter. A short, punchy LinkedIn DM. There is NO subject line. There is NO greeting. There is NO sign-off. Just the message body.\n\n🚨 ABSOLUTE ANTI-HALLUCINATION RULE 🚨\nNever invent experiences, numbers, or prior clients the candidate doesn't have. Use ONLY what's in the resume and voice ramble. Fabrication is a critical failure.\n\nCORE PHILOSOPHY:\n- This is a TEXT MESSAGE, not an email. Punchy. Almost shocking. Two sentences. That's it.\n- The recipient already knows their company. Do NOT recap their news.\n- Goal: get a reply, not close a deal.\n\nSTRUCTURE — UNDER 200 CHARACTERS TOTAL. NON-NEGOTIABLE. Count them.\n- ONE punchy sentence with a sharp, specific hook tied to them. Capitalize the first letter and proper nouns properly — this is not all lowercase.\n- ONE direct CTA framed as "Let's talk about [specific thing I can help with]?" or "Open to a chat about how I'd approach [specific thing]?". The CTA must be a conversational opener about the candidate helping.\n\nTONE: Like a sharp, confident text to a peer. Casual but capitalized properly.\n\nHARD BANS:\n- OVER 200 CHARACTERS (the limit is hard, count them)\n- Subject lines (this is not an email)\n- Greetings: "Hi", "Hello", "Hope you're well"\n- Sign-offs: "Best", "Thanks", name\n- Reciting company news back at them\n- All-lowercase formatting\n- Em-dashes (—)\n- Made-up experience or numbers\n- Generic CTAs not tied to the candidate helping`,
  cover_letter: `===== OUTPUT TYPE: COVER LETTER =====\nYou are generating a FULL COVER LETTER. Not a LinkedIn DM. Not an email. A 3-paragraph cover letter for a job application.\n\n🚨 ABSOLUTE ANTI-HALLUCINATION RULE 🚨\nUse ONLY experiences, numbers, and accomplishments that appear in the candidate's resume or voice ramble. Pull SPECIFIC details directly from the resume — real numbers, real company names, real outcomes. If a detail is not in the source material, do not invent it.\n\nSTRUCTURE — 3 paragraphs:\n- P1 (HOOK): Open with energy and specificity. NEVER "I'm writing to apply". Reference something specific about the company woven in naturally (don't recap their news). Show why this person + this role + now.\n- P2 (BRIDGE): Map 2-3 specific things the company needs to specific things this candidate has done. Use REAL numbers from their resume. Frame as future impact for the employer.\n- P3 (THE WHY): What the resume can't show — personality, perspective, motivation. End on forward momentum about what they want to build, NOT gratitude. Do NOT say "what my resume can't show" or reference the resume meta-textually. Just speak in first person about who you are.\n\nTONE: Real human voice. Confident peer. Specific over general.\n\nHARD BANS:\n- Fabricated experience or numbers\n- Meta-references to the resume itself ("my resume shows", "what my resume can't show")\n- "I'm writing to apply", "I'm excited to apply", "I believe I'd be a great fit"\n- "passionate about", "results-driven", "detail-oriented", "team player", "proven track record", "self-starter"\n- "Thank you for your consideration"\n- Em-dashes (—)\n- Overly poetic / "woo woo" phrases that don't sound like a real person`,
  interview_prep: `===== OUTPUT TYPE: INTERVIEW PREP CHEAT SHEET =====\nYou are generating an INTERNAL INTERVIEW PREP CHEAT SHEET for the candidate themselves. Not a cover letter. Not an email. A scannable cheat sheet with clearly labeled sections.\n\n🚨 ABSOLUTE ANTI-HALLUCINATION RULE 🚨\nEvery story, number, and experience MUST come from the candidate's actual resume or voice ramble. NEVER invent prior clients, percentages, or accomplishments. If the candidate has limited material, work with what's actually there. Fabrication is a critical failure.\n\nFORMAT — use these exact section headers (no decorative bars, no ═══ characters, just bold headers):\n\n**THE COMPANY**\n6-8 sentences with substance: what they do, who they serve, recent moves, market position, key context, leadership notes if relevant. More detail than a snapshot. Pull from the company website data.\n\n**THE REAL PROBLEM THEY'RE HIRING FOR**\n2-3 sentences naming the real pain point behind the job posting.\n\n**YOUR THREE STORIES**\nThree stories pulled DIRECTLY from the candidate's actual resume. Use real numbers, real companies, real titles from the resume verbatim. Each story:\n- Situation: (1 line, specific, from the resume)\n- Decision: (1 line)\n- Outcome: (1 line, with real number from resume if available)\n- Why it lands here: (1 line bridging to this company)\n\n**LIKELY QUESTIONS + WHAT TO EMPHASIZE**\n6-7 BROAD probing questions the interviewer might ask (strengths, weaknesses, leadership style, conflict, why this company, etc.) — NOT hyper-specific questions about the company's strategy. For each question, instead of a one-line angle, provide BULLET POINTS of what to emphasize:\n- Q: [the question]\n  • Specific experience to pull from (cite real resume detail)\n  • Number or outcome to drop in (only if real)\n  • How to tie it to this company\n  • Personality angle to lean into\n\n**QUESTIONS TO ASK THEM**\n5 thoughtful questions. Mix general role/team questions with 1-2 lightly company-specific ones. Don't be hyper-specific — these should feel natural.\n\n**BRIDGE PHRASES**\n3-4 phrases the candidate can drop verbatim that connect their REAL experience to the company.\n\n**DON'T FORGET**\n2-3 personalized reminders pulled from real resume content.\n\nTONE: Direct, tactical, "you" voice, no fluff.\n\nHARD BANS:\n- Decorative bars (═══) or ASCII art around headers — use bold markdown headers only\n- Hallucinated experiences, numbers, or clients\n- Hyper-specific strategy questions (use general probing questions instead)\n- One-line angle answers (use bullet points instead)\n- Em-dashes (—)`,
}
    ...
    try {
      ...
      const r = await fetch("/api/generate", { method: "POST", headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ system: "You are an elite career strategist and copywriter. Surgical precision. No filler, no cliches. Deep company knowledge. Confident, sharp, human tone. Follow formatting EXACTLY.",
          messages: [{ role: "user", content: `🔒 LOCKED OUTPUT TYPE: ${selectedOutput.toUpperCase()} 🔒\nYou MUST generate ONLY a ${selectedOutput.replace("_", " ")}. Do not generate any other format. If you generate the wrong format, the entire tool fails.\n\n${outputTypePrompts[selectedOutput]}\n\n=== SOURCE MATERIAL (the ONLY facts you may use) ===\n\nCANDIDATE RESUME:\n${profile.resumeText || "Not provided"}\n\nCANDIDATE'S OWN WORDS (voice ramble):\n${profile.rambleText || "Not provided"}\n\nTARGET COMPANY DATA:\n${companyData}\n\nTARGET ROLE: ${targetRole || "Decision maker"}\n\nADDITIONAL CONTEXT FROM CANDIDATE:\n${voiceContext || "None"}\n\n⚠️ CRITICAL: Use ONLY facts from the source material above. Never invent numbers, prior clients, percentages, or experiences. If the candidate has nothing relevant, omit that section rather than fabricate.\n\nFINAL CHECK BEFORE OUTPUT: Confirm you are generating a ${selectedOutput.replace("_", " ")} and ONLY a ${selectedOutput.replace("_", " ")}. Write ONLY the deliverable. No preamble, no explanation.` }] }) });
      const d = await r.json();
      ...
      {step === STEPS.WELCOME && (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", gap: 32, animation: "fadeUp 0.7s cubic-bezier(0.4,0,0.2,1)", maxWidth: 560, textAlign: "center" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 17, color: c.textSecondary, lineHeight: 1.7, maxWidth: 440, margin: "20px auto 0" }}>Upload your resume, talk about yourself, and we&apos;ll craft cold emails, LinkedIn DMs, cover letters, and interview prep — ready to send.</p>
          </div>
