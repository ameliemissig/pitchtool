...
const outputTypePrompts = {
  cold_email: `a cold outreach email. Requirements:\n- Subject line referencing something SPECIFIC about the company\n- Maximum 4 sentences in the body\n- Each sentence on its own line with a blank line between\n- Sentence 1: Sharp, specific observation about their company. NEVER start with "I" — start with THEM.\n- Sentence 2: The insight or gap and how it connects to what you do\n- Sentence 3: One concrete result you've delivered (with a number if possible)\n- Sentence 4: A single clear CTA\n- Tone: confident peer offering value. NOT a job seeker.\n- BANNED: "I hope this finds you well", "I'd love to", "I came across", "reaching out because", "just wanted to"`,
  linkedin_dm: `a LinkedIn direct message. STRICT:\n- MUST be under 200 characters total. NON-NEGOTIABLE.\n- One hook + one CTA. Two short sentences max.\n- Hook must reference something SPECIFIC\n- NO greeting, NO pitching services, NO formal language.\n- Goal: start a conversation, not pitch.`,
  cover_letter: `a cover letter. Requirements:\n- 3 tight paragraphs. Zero fluff.\n- P1: Name the EXACT role. Reference something hyper-specific about the company.\n- P2: Map 2-3 SPECIFIC job requirements to experience with explicit proof and numbers.\n- P3: Something the resume doesn't capture — personal motivation or vision. Close with forward momentum.\n- BANNED: "I'm excited to apply", "I believe I'd be a great fit", "I'm passionate about"`,
  interview_prep: `an interview preparation guide with clear headers:\n\nCOMPANY SNAPSHOT (4-5 sentences)\nROLE ANALYSIS (what this role really requires)\nLIKELY QUESTIONS (7) with "Q:" and "Your angle:" format\nQUESTIONS TO ASK THEM (5) — smart, researched\nKEY TALKING POINTS (4)`,
  elevator_pitch: `a 30-second elevator pitch to be SPOKEN aloud:\n- 3-4 sentences max\n- Sentence 1: Who you are framed around OUTCOME, not title\n- Sentence 2: Who you help and what result (include a number)\n- Sentence 3: What makes you different\n- Sentence 4: Conversational bridge\n- Must sound natural spoken aloud`,
};
